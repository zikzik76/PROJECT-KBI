<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryDocument.aspx.cs" Inherits="Penjaminan.Master.EntryDocument1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script>
        function back() {
            window.location.replace(window.location.origin + '/Master/ViewDocument');
        }
    </script>
</asp:Content>
                ...
                <div class="card-body ">
                    <form method="post" runat="server">
                        <input type="hidden" id="txtId" value="" runat="server">
                         <div class="row">
                            ...
                            <div class="form-group">
                                 <asp:DropDownList class="form-control" ID="DropDownList1" runat="server" DataTextField="name" DataValueField="id" AutoPostBack="true" OnSelectedIndexChanged="itemSelected">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                            <div class="form-group">
                                <input type="text" class="form-control" id="txtDescription" value="" runat="server">
                            </div>
                            </div>
                        </div>
                        <div class="row">
