<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryWorkflow.aspx.cs" Inherits="Penjaminan.Master.EntryWorkflow" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script>
        function back() {
            window.location.replace(window.location.origin + '/Master/ViewWorkflow');
        }
    </script>
</asp:Content>
                ...
                <div class="card-body ">
                    <form method="post" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                            <div class="form-group">
                                <input type="text" class="form-control" id="txtSequence" value="" runat="server">
                            </div>
                            </div>
                        </div>
                        <div class="row">
