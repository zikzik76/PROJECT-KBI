...
{
    public partial class EntryKategori : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblMenu.Text = "Entry Master Kategori";
            Session["activepage"] = "kategori";
        }

        private void bindData()
        {
            PenjaminanDataset.m_kategoriRow dr = m_kategori.selectKategoriByID(eID);
        ...
        {
            m_kategori.SoftDeleteData(id);
            Response.Redirect("/Master/ViewKategori.aspx");
        }
        ...
        protected void btnSubmit_click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    m_kategori.UpdateData(eID, txtName.Value, txtDescription.Value);
                }
                else if (eID == 0 && IsValidEntry())
                {
                    m_kategori.InsertData(txtName.Value, txtDescription.Value);
                }
                Response.Redirect("/Master/ViewKategori.aspx");
            }
            catch (Exception ex)
