<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryBidangUsaha.aspx.cs" Inherits="Penjaminan.Master.EntryBidangUsaha" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script>
        function back() {
            window.location.replace(window.location.origin + '/Master/ViewBidangUsaha');
        }
    </script>
</asp:Content>
