<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryPerusahaan.aspx.cs" Inherits="Penjaminan.Master.EntryPerusahaan" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script>
        function back() {
            window.location.replace(window.location.origin + '/Master/ViewPerusahaan');
        }
    </script>
</asp:Content>
