<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryMitraBidangUsaha.aspx.cs" Inherits="Penjaminan.Penjaminan.EntryMitraBidangUsaha" EnableViewState="true"%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <asp:DropDownList ID="cboBidangUsaha" runat="server" class="selectpicker">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
