<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryMitraChecklist.aspx.cs" Inherits="Penjaminan.Penjaminan.EntryMitraChecklist" %>
                        ...
                        <div class="card-body ">
                            <form method="post" class="form-horizontal" autocomplete="off" runat="server">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="txtTanggalPelaksanaan" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="txtNilai" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="txtTanggalSerah" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 checkbox-radios">
                                        <div class="form-check form-check-inline">
                                            <button type="submit" class="btn btn-success btn-round" onclick="btnSubmit_Click">Save</button>
