                        ...
                        <div class="card-body ">
                            <form method="post" class="form-horizontal" autocomplete="off" runat="server">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="date" class="form-control" id="txtTanggalPelaksanaan" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="number" class="form-control" id="txtNilai" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="date" class="form-control" id="txtTanggalSerah" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
