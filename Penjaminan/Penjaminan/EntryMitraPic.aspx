<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryMitraPic.aspx.cs" Inherits="Penjaminan.Penjaminan.EntryMitraPic" %>
                        ...
                        <div class="card-body ">
                            <form method="post" class="form-horizontal" autocomplete="off" runat="server">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="txtJabatan" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="number" class="form-control" id="txtNoTelepon" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="txtEmail" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
